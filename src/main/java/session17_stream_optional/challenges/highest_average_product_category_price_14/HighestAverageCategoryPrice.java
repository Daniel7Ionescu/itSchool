...
public class HighestAverageCategoryPrice {
    ...
    public static void main(String[] args) {
        ...
        Product productSparkle = new Product("Fresh Sparkles", Category.DRINKS, 7.50);
        Product productPurpleDrink = new Product("Purple Drink", Category.DRINKS, 9.50);
        Product productFancyTapWater = new Product("Fancy Tap Water", Category.DRINKS, 12.50);
        Product productTheDragon = new Product("The Dragon", Category.BIG_TOYS, 25.49);
        ...
        List<Product> productList = Arrays.asList(productSparkle, productPurpleDrink, productTheDragon,
                productMidnightDanger, productSnackAttack, productNotRoundPizza, productFancyTapWater);
        ...
        String categoryListMap = productList.stream()
                ...
                .collect(Collectors.groupingBy(element -> element.getCategory()))
                .entrySet().stream()
